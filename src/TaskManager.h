...
/**
 * Definition of a function to be called back when an interrupt is detected,
 * marshalled by task manager into a task. The pin that caused the interrupt is
 * passed in the parameter on a best efforts basis.
